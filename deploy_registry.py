...
sftp = cl.open_sftp()
sftp.put(r'd:\project\1Cfresh\frontend\components\clients\ClientsList.tsx',
         '/var/www/integration-1c/frontend/components/clients/ClientsList.tsx')
sftp.close()
print("Uploaded ClientsList.tsx")
...
print(f"Health: {code}")
cl.close()
print("Done → /clients should now show registry layout")
