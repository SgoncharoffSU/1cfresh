"""Deploy: chat state in URL — survives page refresh."""
...
FILES = [
    (r'd:\project\1Cfresh\frontend\app\(dashboard)\chats\page.tsx',
     '/var/www/integration-1c/frontend/app/(dashboard)/chats/page.tsx'),
