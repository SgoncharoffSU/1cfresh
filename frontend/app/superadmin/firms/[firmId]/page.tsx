...
export default function SuperAdminFirmDetailPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-5">
      <Link href="/superadmin/firms" className="inline-flex items-center gap-1 text-xs text-slate-500 hover:text-slate-900 dark:hover:text-slate-300">
      ...
      {error && (
        <p className="text-xs text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 border border-red-100 dark:border-red-900 rounded-lg px-3 py-2">{error}</p>
      )}
